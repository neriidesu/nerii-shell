...
ScrollView {
    ...
    property color handleColor: Qt.alpha(Colors.md3.tertiary, 0.8)
    ...
    property color gradientColor: Colors.md3.surface_variant
    ...
    WheelHandler {
        enabled: root.wheelScrollMultiplier !== 1 && root._internalFlickable !== null
    ...
    ScrollBar.vertical: ScrollBar {
        ...
        contentItem: Rectangle {
            ...
            opacity: parent.policy === ScrollBar.AlwaysOn ? 1 : root.verticalScrollable ? ((root.showScrollbarWhenScrollable || parent.active) ? 1 : 0) : 0
        ...
        background: Rectangle {
            ...
            opacity: parent.policy === ScrollBar.AlwaysOn ? 0.3 : root.verticalScrollable ? ((root.showScrollbarWhenScrollable || parent.active) ? 0.3 : 0) : 0
    ...
    ScrollBar.horizontal: ScrollBar {
        ...
        contentItem: Rectangle {
            ...
            radius: root.handleRadius
            color: parent.pressed ? root.handlePressedColor : parent.hovered ? root.handleHoverColor : root.handleColor
            opacity: parent.policy === ScrollBar.AlwaysOn ? 1 : root.horizontalScrollable ? ((root.showScrollbarWhenScrollable || parent.active) ? 1 : 0) : 0
        ...
        background: Rectangle {
            ...
            implicitHeight: root.handleWidth
            color: root.trackColor
            opacity: parent.policy === ScrollBar.AlwaysOn ? 0.3 : root.horizontalScrollable ? ((root.showScrollbarWhenScrollable || parent.active) ? 0.3 : 0) : 0
            radius: root.handleRadius / 2
