...
ColumnLayout {
    ...
    readonly property string indicatorTooltip: defaultValue !== undefined ? "(empty)" : ""
    ...
    Control {
        ...
        background: Rectangle {
            ...
            border.color: input.activeFocus ? Colors.md3.tertiary : Colors.md3.primary
            ...
            Item {
                ...
                RowLayout {
                    ...
                    TextField {
                        ...
                        placeholderTextColor: Qt.alpha(Colors.md3.on_surface_variant, 0.6)
                        color: enabled ? Colors.md3.on_surface : Qt.alpha(Colors.md3.on_surface, 0.4)
                        selectByMouse: true
                        topPadding: 0
                        bottomPadding: 0
                        leftPadding: 0
