...
Item {
    ...
    GridView {
        ...
        WheelHandler {
            enabled: root.wheelScrollMultiplier !== 1
        ...
        ScrollBar.vertical: ScrollBar {
            ...
            contentItem: Rectangle {
                ...
                opacity: parent.policy === ScrollBar.AlwaysOn ? 1 : root.verticalScrollBarActive ? ((root.showScrollbarWhenScrollable || parent.active) ? 1 : 0) : 0
            ...
            background: Rectangle {
                ...
                opacity: parent.policy === ScrollBar.AlwaysOn ? 0.3 : root.verticalScrollBarActive ? ((root.showScrollbarWhenScrollable || parent.active) ? 0.3 : 0) : 0
